...
start_all() {
  ...
  start_service \
    ...
    SERVICE_BACKEND_SERVICE_PUBLIC_BASE_URL="${SERVICE_BACKEND_SERVICE_PUBLIC_BASE_URL:-http://127.0.0.1:$FRONTEND_PORT}" \
  ...
  start_service \
    ...
    VITE_HUB_API_BASE_URL="${VITE_HUB_API_BASE_URL:-http://127.0.0.1:10010/api/v1}" \
    VITE_HUB_LOGIN_URL="${VITE_HUB_LOGIN_URL:-http://127.0.0.1:10011/login}" \
