...
APP_HOST_IP="${APP_HOST_IP:-192.168.1.242}"
...
HUB_SERVICE_CREDENTIALS_PATH="${HUB_SERVICE_CREDENTIALS_PATH:-$RUNTIME_DIR/hub-service-credentials.json}"
...
start_all() {
  ...
  start_service \
    ...
    SERVICE_BACKEND_SERVICE_PUBLIC_BASE_URL="${SERVICE_BACKEND_SERVICE_PUBLIC_BASE_URL:-$APP_SCHEME://$APP_HOST_IP:$FRONTEND_PORT}" \
    SERVICE_BACKEND_CORS_ALLOWED_ORIGINS="${SERVICE_BACKEND_CORS_ALLOWED_ORIGINS:-$APP_SCHEME://$APP_HOST_IP:$FRONTEND_PORT,$APP_SCHEME://$APP_HOST_IP:4173}" \
    SERVICE_BACKEND_RUN_EMBEDDED_WORKER=false \
    SERVICE_BACKEND_WORKER_HEARTBEAT_PATH="$WORKER_HEARTBEAT_PATH" \
    SERVICE_BACKEND_HUB_SERVICE_CREDENTIALS_PATH="$HUB_SERVICE_CREDENTIALS_PATH" \
    SERVICE_WORKER_HUB_SERVICE_CREDENTIALS_PATH="$HUB_SERVICE_CREDENTIALS_PATH" \
  ...
  start_service \
    ...
    VITE_DEV_PROXY_TARGET="${VITE_DEV_PROXY_TARGET:-$APP_SCHEME://$APP_HOST_IP:$BACKEND_PORT}" \
    VITE_HUB_API_BASE_URL="${VITE_HUB_API_BASE_URL:-$APP_SCHEME://$APP_HOST_IP:10010/api/v1}" \
    VITE_HUB_LOGIN_URL="${VITE_HUB_LOGIN_URL:-$APP_SCHEME://$APP_HOST_IP:10011/login}" \
  ...
  echo
  echo "Frontend: $APP_SCHEME://$APP_HOST_IP:$FRONTEND_PORT"
  echo "Backend:  $APP_SCHEME://$APP_HOST_IP:$BACKEND_PORT/docs"
