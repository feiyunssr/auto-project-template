...
from apps.backend.core.errors import ProviderRateLimitError, ProviderTimeoutError, ServiceError
from apps.backend.models import ServiceAiProfile, ServiceArtifact, ServiceJobAttempt, ServiceResult
from apps.backend.models.enums import AttemptStatus, JobStatus, QualityStatus
from apps.backend.models.mixins import utcnow
from apps.backend.repositories.ai_profiles import AiProfileRepository
from apps.backend.repositories.tasks import TaskRepository
from apps.backend.services.provider_registry import get_provider_adapter
from apps.backend.services.state_machine import ensure_transition
