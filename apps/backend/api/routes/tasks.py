...
from apps.backend.api.dependencies import get_auth_context, get_db_session, get_runtime
from apps.backend.core.errors import ServiceError, ValidationFailedError
from apps.backend.models import ServiceJob
...
from apps.backend.schemas.tasks import (
...
async def create_task(
    ...
    await runtime.worker.enqueue(job.id)
    logger.info(
